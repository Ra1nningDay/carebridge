...
use App\Http\Controllers\Survey\PM25AssessmentController;
...
Route::prefix('survey')->group(function () {
    ...
    Route::get('/pm25/create', [PM25AssessmentController::class, 'create'])->name('pm25_assessments.create');
    Route::post('/pm25', [PM25AssessmentController::class, 'store'])->name('pm25_assessments.store');
    Route::get('/pm25/{assessment}', [PM25AssessmentController::class, 'show'])->name('pm25_assessments.show');
